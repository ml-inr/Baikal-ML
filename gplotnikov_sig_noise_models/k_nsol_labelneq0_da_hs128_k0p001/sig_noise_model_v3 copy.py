...
MODEL_DIR = Path(__file__).resolve().parent.parent / "encoder_nl5_nh1_dff512_hs512_bs128"
DEFAULT_CHECKPOINT = MODEL_DIR / "best_2020.ckpt" #"best_mc_2020.ckpt"
DEFAULT_CONFIG = MODEL_DIR / "noise_sig.yaml" #"train_config_mc_2020.yaml"
...
class SigNoiseModel(nn.Module):
    def __init__(
        self, in_features, hidden_size, num_layers,
        dim_feedforward_size, n_heads, out_size, dropout_p=0.0, **kwargs,
    ):
        super().__init__()
