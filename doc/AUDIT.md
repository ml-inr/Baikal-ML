...
Шесть обёрток в `scripts/` ссылаются на **несуществующие** пути:
...
(§3.7) и шести обёрток `scripts/train_*.sh`, указывавших на старые пути (§1.6;
пути исправлены 2026-09-06).
