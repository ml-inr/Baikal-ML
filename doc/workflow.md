...
## User Customization Phase

**When user needs to adapt code independently:**
1. Mark iteration as "In Progress" in [tasklist.md](tasklist.md)
2. User works independently on customization
3. Assistant remains available for specific help when requested
4. User can ask for:
   - Code reviews and suggestions
   - Debugging assistance
   - Architecture guidance
   - Implementation help for specific functions
5. Once user completes customization, mark iteration as "Complete"
6. Proceed to next iteration with user agreement

**Key principles during customization:**
- Don't implement without being asked
- Provide guidance when requested
- Follow KISS principles in suggestions
- Maintain coding conventions from [conventions.md](../conventions.md)
- Help validate results when asked

## Next Steps

**Iteration 2.5: Adapt Data Manager** - ✅ **COMPLETED**
- User successfully implemented complete `root2h5` conversion module
- Production-ready multiprocessing system with physics calculations
- Advanced data handling for Baikal detector-specific requirements
- Quality control and validation implemented

**Iteration 2.6: PyTorch Dataset** - ✅ **COMPLETED**
- Successfully implemented BaikalMCDataset for neutrino/muon binary classification
- Complete test suite passing (4/4 tests)
- Memory-efficient loading with variable-length sequence support
- Ready for neural network training

**Iteration 3: Simple Model + Training** - ✅ **COMPLETED**
- Successfully implemented attention-based Transformer models for neutrino detection
- Complete training pipeline with comprehensive metrics and device handling
- Production-ready configuration system with experiment management
- TensorBoard integration implemented

**Iteration 4: Domain Adaptation Trainer** - ✅ **COMPLETED**
- DANN adversarial training pipeline for MC→Exp domain adaptation
- Gradient Reversal Layer domain discriminator
- Extensive lambda sweep experiments — best model identified
- Best val AUC: 0.9777 (`da_numu_251123_small_moderatelambdmidddnoreg_aug_newlr`)

**Iteration 4b: Hit-Cut Task** - ✅ **COMPLETED**
- Side branch: modified classification where events with <5 signal hits are labeled as background
- Separate dataset, trainer, and normalization stats for the hcut regime
- Lambda sweep experiments completed — best model identified
- Best val AUC: 0.9440 (`da_hcut5_numu_260206_smallnn_bigds_middleddnoreg_0.2lambda_aug_correct`)

**Next:** **Iteration 8** — Validate quality of both best prefilter models on real experimental data, then proceed to **Iteration 9: Signal-Hits Regime** (precision selection, >10⁶× background suppression)