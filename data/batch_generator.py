...
class BatchGenerator:
    ...
    def __init__(self, cfg: BatchGeneratorConfig, collect_stats=False):
        ...
        self.chunks = cfg.chunk_generator.get_chunks()
    ...
    def get_batches(self, bs: Optional[int] = None) -> Generator[tuple[Tensor, Tensor], None, None]:
        ...
        for chunk in self.chunks:
            ...
            for start in range(0, chunk.shape[0], bs):
                ...
                logging.debug("Batch %d generated. features_batch shape: %s, labels_batch shape: %s", batch_index, features_batch.shape, labels_batch.shape)
                batch_index += 1
