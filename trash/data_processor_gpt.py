...
from data.processing.config import ProcessorSettings
...
class Processor:
    ...
    def process(
        ...
        Returns:
            Tuple[pl.DataFrame, pl.DataFrame, pl.DataFrame]: Filtered DataFrames for events, pulses, and muons.
        """
        ...
        # Calculate t_res and join to pulses DataFrame
