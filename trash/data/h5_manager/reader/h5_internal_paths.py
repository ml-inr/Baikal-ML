...
@dataclass
class GeomPaths(BaseFeaturePaths):
    """
    Paths to features of
    individual pulses in events
    """
    Xc: str = "<ParticleType>/clusters_centers/data.0"
    Yc: str = "<ParticleType>/clusters_centers/data.1"
    Zc: str = "<ParticleType>/clusters_centers/data.2"
