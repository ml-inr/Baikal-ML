...
class FilterParams(BaseConfig):
    ...
    only_signal: bool = False  # Whether to filter only signal hits
    min_hits: int = 0  # Minimum number of hits per cluster to be kept
    min_strings: int = 0  # Minimum number of unique single strings in a cluster
