...
class ExpRecoEventFeaturesPaths(EventFeaturesPaths):
    ...
    fThetaErr: str = 'BRecoMuon./BRecoMuon.fThetaErr'
    fNHits: str = 'BRecoMuon./BRecoMuon.fNHits'
    fPhiRec: str = 'BRecoMuon./BRecoMuon.fPhiRec'
    fPhiErr: str = 'BRecoMuon./BRecoMuon.fPhiErr'
    fPathLength: str = 'BRecoMuon./BRecoMuon.fPathLength'
    
@dataclass
class MCRecoEventFeaturesPaths(EventFeaturesPaths):
    # Prime particle features
    PrimeTheta: str = "BMCEvent./BMCEvent.fPrimaryParticleTheta"
    PrimePhi: str = "BMCEvent./BMCEvent.fPrimaryParticlePhi"
    PrimeEn: str = "BMCEvent./BMCEvent.fPrimaryParticleEnergy"
...
class ExpPulsesFeaturesPaths(PulsesFeaturesPaths):
    ...
    SignalFlg: str = "ScanfitMask./ScanfitMask.fOrigins/ScanfitMask.fOrigins.fFlag"
...
@dataclass
class MCRecoRootPaths(BaseRootPaths):
    data_header: str = "Events"
    coords_header: str = "Events"
    ev_paths: EventFeaturesPaths = MCRecoEventFeaturesPaths()
    ind_mu_paths: MuonsFeaturesPaths = MCMuonsFeaturesPaths()
    pulses_paths: PulsesFeaturesPaths = MCPulsesFeaturesPaths()
